...
public class ShootRifle : MonoBehaviour
{
    ...
    void CasingRelease()
    {
        ...
        tempCasing.GetComponent<Rigidbody>().AddExplosionForce(Random.Range(ejectPower * 5f, ejectPower), (casingExitLocation.position - casingExitLocation.right * 0.3f - casingExitLocation.up * 0.6f), 1f);
